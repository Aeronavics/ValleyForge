 ...
 *  FILE: 		stm_magic.hpp
 *
 *  TARGET:		All STM Targets.
 *
 *  AUTHOR: 		Anton Slooten
 *
 *  DATE CREATED:	22-12-2011
 *
 *	This is the header file which matches avr_magic.cpp.  Performs some magic, neccesary because C++ support by stm-gcc is not
 *	complete.
 * 
 ********************************************************************************************************************************/
...
extern "C" int __dso_handle(void);
