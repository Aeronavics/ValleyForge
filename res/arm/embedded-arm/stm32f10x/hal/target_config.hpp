 ...
 * 
 * @brief
 * This contains device specific definitions for STM32F10x devices. Information such as timer size, interrupt
...
#include <<<TC_INSERTS_IO_FILE_NAME_HERE>>>
	...
	enum CAN_BUF {BUF_0, BUF_1, BUF_2, BUF_3, BUF_4};	// First 3 are transmit buffers, last 2 are receive buffers.
